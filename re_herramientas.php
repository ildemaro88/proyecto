...
<body>
	...
	<div class=" col-md-offset-4 col-md-4">
            <form action="index.php" method="post" class="formInicio">    
                <div class="">
                    <h2>Registrar Casas</h2>
                </div> 
                <div class="form-group">
                    <div class="">
                        <label for="usuario" class="">Numero casa</label>
                        <input type="text" placeholder="Numero de la casa" class="form-control" name="usuario"/>
                    </div>  
                    <div class="">
                        <label for="usuario" class="">Direccion</label>
                        <input type="text" placeholder="Direccion o Referencia" class="form-control" name="usuario"/>
                    </div>   
                </div>
                <div class="">
