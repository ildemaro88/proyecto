...
class Usuario extends Modelo{
    ...
    public function __construct($usuario=" ",$clave= " ", $idTrabajador=" ",$idRol=" ", $correo=" ",$estatus=" ",$id=" ",$actualiza=" ") 
    { 
    ...
    public function getAll(){
        $this->query="SELECT u.usuario,
                            concat_ws(' ', t.nombre, t.apellido) AS nombre,
    ...
    public function buscar($idUsuario='') {  
        if($idUsuario !=''):  
            $this->query= " SELECT id_usuario,id_trabajador,correo,id_rol,estatus,usuario FROM ".$this->tabla." WHERE id_usuario = ".$idUsuario.""; 
            $this->get_results_from_query();  
        endif; 
        $usuario = $this->rows;
    ...
    public function guardar() {  
        ...
        echo $msg;
           ...
           $this->query= " SELECT * FROM ".$this->tabla." WHERE id_trabajador = '".$this->idTrabajador."' "; 
            ...
            $this->query= " SELECT * FROM trabajador WHERE id_trabajador = ".$this->idTrabajador.""; 
            $this->get_results_from_query();  
			...
			$correoU = trim($this->correo);
            $miDestinatario	= array("$correoU");
			
            $miSubject ="Nueva cuenta de Usuario";
...
<table id="bodyTable" style="table-layout: fixed; max-width: 100% !important; width: 100% !important; min-width: 100% !important;" border="0" width="100%" cellspacing="0" cellpadding="0">
    <tbody>
        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="textContent" align="left">
                                                                                <div style="font-family: Helvetica,Arial,sans-serif; font-size: 13px; color: #828282; text-align: center; line-height: 120%;">SISTEMA DE GESTI&Oacute;N E INVENTARIO</div>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="textContent" align="left" valign="top">
                                                                    <h3 style="color: #ffffff; line-height: 100%; font-family: Baloo Bhaina, sans-serif; font-size: 35px; font-weight: normal; margin-bottom: 10px; margin-top: 5px;">¡Nuevo Usuario!</h3>
                                                                    <div style="height: 30px; background: #34495e;">
                                                                        <h4 style="text-align: left; font-weight: normal; font-family: Helvetica,Arial,sans-serif; font-size: 16px; margin-bottom: 10px; margin-left: 5px; color: white; line-height: 135%; margin-top: 10px; padding-top: 3px; font-style: italic;">Sistema de Gesti&oacute;n e Inventario</h4>
                                                                    </div>
                                                                    <div style="height: 3px; background: #7f8c8d; margin-bottom: 8px;">&nbsp;</div>
                                                                    <div style="text-align: left; font-family: Roboto,Arial,sans-serif; font-size: 15px; font-weigth:100; margin-bottom: 0; color: #ffffff; line-height: 135%;">Estimado <b>'.$usuario[0]['nombre'].' '.$usuario[0]['apellido'].'</b> <br /> Su cuenta ha sido creada correctamente, a continuaci&oacute;n puede ver el detalle de la misma:</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                                        ...
                                                                        <td class="flexibleContainerBox" align="left" valign="top">
                                                                            <table style="max-width: 100%;" border="0" width="210" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="textContent" align="left">
                                                                                            <h3 style="color: #5f5f5f; line-height: 125%; font-family: Roboto,sans-serif; font-size: 20px; font-weight: normal; margin-top: 0; margin-bottom: 3px; text-align: left;">Detalle de la Cuenta:</h3>
                                                                                            <br>
                                                                                            <div style="text-align: left; font-family: Helvetica,Arial,sans-serif; font-size: 15px; margin-bottom: 0; color: #5f5f5f; line-height: 135%;"><strong>Usuario:</strong> '.$this->usuario.'</div>
                                                                                            <div style="text-align: left; font-family: Helvetica,Arial,sans-serif; font-size: 15px; margin-bottom: 0; color: #5f5f5f; line-height: 135%;"><strong>Contrase&ntilde;a: </strong>'.$this->clave.'</div>
                                                                                            <br>
                                                                                            ...
                                                                                            <div style="text-align: left; font-family: Helvetica,Arial,sans-serif; font-size: 15px; margin-bottom: 0; color: #5f5f5f; line-height: 135%;">Atentamente,
                                                                                                <br><br>Sistema automatizado <br> <strong>SISTEMA DE GESTI&Oacute;N <br/> E INVENTARIO</strong></div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                                <div style="font-family: Helvetica,Arial,sans-serif; font-size: 13px; color: #828282; text-align: center; line-height: 120%;">
                                                                                    <div>No contestar este correo.</div>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
            ...
            $transport = Swift_SmtpTransport::newInstance($miServidor, $miPuertoSMTP, 'ssl') // Puerto de salida SMTP
