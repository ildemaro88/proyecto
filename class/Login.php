...
class Login extends Modelo {
    ...
    public function recuperar($user_email=""){
        $this->query="SELECT * From usuario where correo='".$user_email."' and usuario.estatus = 1";
       ...
       // echo "Lo sentimos. No se pudo encontrar una coincidencia. Inténtelo de nuevo.";
         //header('location: index.php?error=1');
        $_SESSION["recuperar"] = 2;
    }else{

         $clave = rand(0,9999999);

         $claveCorreo = $clave;

         $clave = md5($clave);

         $this->query = "UPDATE  ".$this->tabla." SET clave='".$clave."' WHERE correo = '".$user_email."'";
        ...
        $msg = $this->execute_single_query(); 
            ...
            $miDestinatario = array("$user_email");
            $miSubject ="RECOM";
...
<table id="bodyTable" style="table-layout: fixed; max-width: 100% !important; width: 100% !important; min-width: 100% !important;" border="0" width="100%" cellspacing="0" cellpadding="0">
    <tbody>
        <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="textContent" align="left" valign="top">
                                                                    <h3 style="color: #ffffff; line-height: 100%; font-family: Baloo Bhaina, sans-serif; font-size: 35px; font-weight: normal; margin-bottom: 10px; margin-top: 5px;">Recuperar Datos de Ingreso</h3>
                                                                    ...
                                                                    <div style="text-align: left; font-family: Roboto,Arial,sans-serif; font-size: 15px; font-weigth:100; margin-bottom: 0; color: #ffffff; line-height: 135%;">Estimado <b>'.$trabajador[0]['nombre'].' '.$trabajador[0]['apellido'].'</b> <br /> Los datos de su cuenta se han recuperado correctamente, a continuaci&oacute;n puede ver el detalle de los mismos:</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="textContent" align="left">
                                                                                            ...
                                                                                            <br>
                                                                                            <div style="text-align: left; font-family: Helvetica,Arial,sans-serif; font-size: 15px; margin-bottom: 0; color: #5f5f5f; line-height: 135%;"><strong>Usuario:</strong> '.$usuario[0]['usuario'].'</div>
                                                                                            <div style="text-align: left; font-family: Helvetica,Arial,sans-serif; font-size: 15px; margin-bottom: 0; color: #5f5f5f; line-height: 135%;"><strong>Contrase&ntilde;a: </strong>'.$claveCorreo.'</div>
                                                                                            <br>
            ...
            ->setFrom(array($miUsuario => 'Recuperar datos de Cuenta'))
